...
export class AppComponent implements OnInit {
    ...
    private handleError(error: Response) {
        if (this.timer == 60000 * 20) {
            this.timer = 60000;
        }
        this.timer *= 2;
        this.setupSubscriptions();

        this.toastr.error('Error getting the latest weather, trying again in ' + (this.timer / 60000) + ' minutes.', 'ERROR', { toastLife: this.timer, showCloseButton: true });
